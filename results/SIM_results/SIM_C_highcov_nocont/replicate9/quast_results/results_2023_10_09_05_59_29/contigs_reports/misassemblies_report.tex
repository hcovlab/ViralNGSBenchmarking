...
\# mismatches & {\bf 0} & 2 & {\bf 0} & 78 \\ \hline
\# indels & {\bf 2} & 3 & {\bf 2} & 26 \\ \hline
\hspace{5mm}\# indels ($\leq$ 5 bp) & {\bf 2} & {\bf 2} & {\bf 2} & 22 \\ \hline
\hspace{5mm}\# indels ($>$ 5 bp) & {\bf 0} & 1 & {\bf 0} & 4 \\ \hline
Indels length & {\bf 6} & 27 & {\bf 6} & 103 \\ \hline
\end{tabular}
\end{center}
\end{table}
\end{document}
