...
\# mismatches & {\bf 0} & {\bf 0} & {\bf 0} & 55 \\ \hline
\# indels & {\bf 3} & 4 & {\bf 3} & 20 \\ \hline
\hspace{5mm}\# indels ($\leq$ 5 bp) & {\bf 1} & {\bf 1} & {\bf 1} & 16 \\ \hline
\hspace{5mm}\# indels ($>$ 5 bp) & {\bf 2} & 3 & {\bf 2} & 4 \\ \hline
Indels length & {\bf 15} & 36 & {\bf 15} & 86 \\ \hline
\end{tabular}
\end{center}
\end{table}
\end{document}
