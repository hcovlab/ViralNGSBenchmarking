...
\# mismatches & {\bf 0} & 4 & 4 & 67 \\ \hline
\# indels & {\bf 10} & {\bf 10} & {\bf 10} & 34 \\ \hline
\hspace{5mm}\# indels ($\leq$ 5 bp) & {\bf 7} & {\bf 7} & {\bf 7} & 29 \\ \hline
\hspace{5mm}\# indels ($>$ 5 bp) & {\bf 3} & {\bf 3} & {\bf 3} & 5 \\ \hline
Indels length & {\bf 39} & {\bf 39} & {\bf 39} & 108 \\ \hline
\end{tabular}
\end{center}
\end{table}
\end{document}
